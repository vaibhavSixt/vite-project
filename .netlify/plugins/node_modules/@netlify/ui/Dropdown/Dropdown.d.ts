...
export declare function Dropdown<ItemValue>({ className, toggle, items, menu, noCaret, onClick, onSelect, scrollable, disabled, alignRight, positionMenuAbove, variant, provider, ButtonAuthProvider, caret, pinnedItems, condensed, itemGroups, noCheck, iconButton, itemToString, ...rest }: DropdownProps<ItemValue>): import("react/jsx-runtime").JSX.Element;
