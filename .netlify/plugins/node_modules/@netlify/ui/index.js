...
import React__default, { createContext, useContext, useState, useRef, useEffect, forwardRef, isValidElement } from "react";
import { cn } from "./helpers/cn.js";
import { getPlaceholderGradientColorsFromId } from "./helpers/placeholderColors.js";
import OriginalTippy from "@tippyjs/react";
import { remToPxNumber } from "./helpers/remToPxNumber.js";
import Downshift from "downshift";
import { capitalize, pluralize } from "./helpers/format.js";
import { createExternalTeamsOrganization, isExternalTeamsOrganization } from "./helpers/organizations.js";
import { ORB_FREE_NAME, ORB_STARTER_NAME, ORB_PRO_NAME, ORB_GROWTH_NAME, STARTER_NAME, PRO_NAME, BUSINESS_NAME, ENTERPRISE_NAME, LEGACY_CREATE_PLAN_UI_NAME } from "./helpers/plans.js";
import { AGENCY_SLUG, BUSINESS_SLUG, ENTERPRISE_SLUG, ENTERPRISE_TRIAL_SLUG, OPEN_SOURCE_NAME, OPEN_SOURCE_SLUG, ORB_FREE_SLUG, ORB_GROWTH_SLUG, ORB_PRO_SLUG, ORB_STARTER_SLUG, PRO_SLUG, STARTER_SLUG, getNormalizedPlanNameFromAccount, getPlanTitleFromAccount, humanizePlanName, isPlanEnterpriseTrial, isPlanPro, isPlanProTrial, isPlanStarter, isPlanTrial } from "./helpers/plans.js";
import { forumsPath, docsPath, billingPath } from "./helpers/path.js";
...
const Picture = ({
  ...
  return /* @__PURE__ */ jsxs("picture", { onError, className, children: [
    sources.map((source, i) => /* @__PURE__ */ jsx("source", { ...source }, `source:${i}`)),
    /* @__PURE__ */ jsx(
      "img",
      {
        src: fallbackSrc,
...
const SvgProvider = ({ children, importSvg }) => {
  return /* @__PURE__ */ jsx(SvgContext.Provider, { value: importSvg, children });
};
const useImportSvg = () => {
...
var IconNameToPath = /* @__PURE__ */ ((IconNameToPath2) => {
  ...
  IconNameToPath2["deploy-diagnostics"] = "icons/icon-deploy-diagnostics";
...
function AccessibleIcon(props) {
  return /* @__PURE__ */ jsx(DecorativeIcon, { "aria-hidden": void 0, role: "img", ...props });
}
...
const tooltipBtnCN = (className) => cn(
  "!tw-bg-transparent",
  "tw-border-none",
  "tw-rounded-full",
  "tw-inline-flex",
          ...
          "span",
          {
            ...
            children: /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx(AccessibleIcon, { title, name: iconName })
              }
            )
          }
        )
...
function Avatar({
  ...
  const classNames = cn(
    ...
    dropdown ? `tw-absolute tw-inset-0 tw-w-avatar-md tw-text-xl tw-leading-[theme('height.avatar-md')]` : "tw-relative",
    className
  );
  ...
  if (src && !isErrored) {
    ...
    return /* @__PURE__ */ jsx(AvatarWrapper, { hoverTooltip, children: /* @__PURE__ */ jsx(
      "span",
      {
        className: classNames,
        title: formattedTitle,
        "data-chromatic": "ignore",
        children: customAvatar ? /* @__PURE__ */ jsx(
          Picture,
          {
  ...
  const placeholder = placeholderText || username && lodashSplit(username, "", 1)[0].toUpperCase();
  const backgroundColors = placeholderBackgroundColors || getPlaceholderGradientColorsFromId(user == null ? void 0 : user.id);
  return /* @__PURE__ */ jsx(AvatarWrapper, { hoverTooltip, children: /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      children: [
        placeholder,
        alt && /* @__PURE__ */ jsx("span", { className: "tw-sr-only", children: altInfo })
      ]
    }
  ) });
}
const AdditionalUsersTooltipContent = ({
  ...
  return /* @__PURE__ */ jsx("span", { className: "tw-flex tw-flex-col tw-items-center", children: additionalTextType === "useName" ? /* @__PURE__ */ jsxs(Fragment, { children: [
    additionalUsers.map((user, index = 0) => {
      return /* @__PURE__ */ jsx("span", { children: user == null ? void 0 : user.full_name }, `additional-user-${index}`);
    }),
    additionalUsersText
...
const listItemClassName = (size) => cn(
  "tw-shrink-0",
  "tw-rounded-full",
  "tw-border-white",
    ...
    "ul",
    {
      ...
      children: [
        items.map((user) => {
          ...
          return /* @__PURE__ */ jsx("li", { className: listItemClassName(size), children: /* @__PURE__ */ jsx(
            Avatar,
            {
              alt: true,
              user,
        ...
        renderAdditionalUsers && /* @__PURE__ */ jsx("li", { className: listItemClassName(size), children: /* @__PURE__ */ jsx(
          Avatar,
          {
            ...
            hoverTooltip: includeHoverTooltips ? /* @__PURE__ */ jsx(
...
const LinkProvider = ({ children, renderLink }) => {
  return /* @__PURE__ */ jsx(LinkContext.Provider, { value: renderLink, children });
};
const useLink = () => {
...
const LinkBase = ({
  ...
  return to || href || !onClick ? renderLink({
    ...
    children: /* @__PURE__ */ jsxs(Fragment, { children: [
      upgrade && /* @__PURE__ */ jsx(DecorativeIcon, { name: "locked" }),
      children
    ] })
  }) : /* @__PURE__ */ jsx(
    "button",
        ...
        children: [
          iconName && /* @__PURE__ */ jsx(
            DecorativeIcon,
            {
              ...iconProps,
              name: iconName,
              className: cn("tw-mr-0.5 tw-align-bottom", iconProps == null ? void 0 : iconProps.className),
              focusable: "false"
            }
          ),
          children
...
const BetaBadge = ({ heading, className }) => {
  ...
  return /* @__PURE__ */ jsx(Badge, { as: "sup", variant: BadgeVariant.Pop, className: betaBadgeCN, children: "Beta" });
};
const MainBranchBadge = () => /* @__PURE__ */ jsx(Badge, { variant: BadgeVariant.Highlight, children: "Production" });
const NewBadge = ({ className }) => /* @__PURE__ */ jsx(Badge, { className, variant: BadgeVariant.Highlight, children: "New" });
...
const render = ({
  ...
  if (iconName) {
    ...
    return hasIconLeft ? /* @__PURE__ */ jsxs("span", { className: withIconWrapperCN, children: [
      renderIcon,
      children
    ] }) : /* @__PURE__ */ jsxs("span", { className: withIconWrapperCN, children: [
      children,
      renderIcon
    ] });
  }
...
const ButtonIcon = React__default.forwardRef(
  ({
    children,
    variant,
    level,
    ...
    const iconWrapper = /* @__PURE__ */ jsx(
      "span",
      {
        className: cn(
        ...
        children: iconName && title ? /* @__PURE__ */ jsx(
          AccessibleIcon,
          {
            title,
            name: iconName,
...
function $090815f5086f7f29$var$reactToText(node, resolvers) {
  ...
  const [nodeType, nodeProps] = /* @__PURE__ */ isValidElement(node) ? [
    node.type,
    node.props
  ] : [
    null,
...
const HistoryContext = createContext(void 0);
...
const SelectedIcon = () => /* @__PURE__ */ jsx(
  AccessibleIcon,
  {
    title: "selected",
    "aria-label": "selected",
  ...
  return /* @__PURE__ */ jsx(
    Downshift,
    {
      ...
      children: ({
        ...
        if (!hasMenu) {
          return toggle ? null : /* @__PURE__ */ jsx("div", { className, ...rootProps, children: label });
        }
            ...
            children: [
              /* @__PURE__ */ jsxs(
                DropdownButton,
                {
                  ...
                  className: provider ? "tw-w-full tw-bg-white dark:tw-bg-black" : cn(
                  ...
                  children: [
                    label,
                    !noCaret && !checkIfExists(button, "saving") && /* @__PURE__ */ jsx(
                      DecorativeIcon,
                      {
              ...
              /* @__PURE__ */ jsxs(
                MenuWrapper,
                {
                  className: cn("dropdown-inner dropdown-menu", menu == null ? void 0 : menu.className, {
                    "!tw-left-auto !tw-right-0": align === "right",
                    "tw-bottom-[calc(100%+theme(spacing.2))] tw-top-auto": positionMenuAbove
                  }),
                  ...
                  children: [
                                ...
                                items2.map((item2, index2) => {
                                  ...
                                  return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(
                                    Link,
                                    {
                                      ...
                                      className: cn("menuitem", className2, {
                                      ...
                                      children: [
                                        item2.label,
                                        !noCheck && isItemSelected(item2, selectedItem) && /* @__PURE__ */ jsx(SelectedIcon, {})
                                      ]
                                    }
                                  ) }, index2);
                                })
                    ...
                    pinnedItems && pinnedItems.length > 0 && /* @__PURE__ */ jsx("ul", { className: "divider", children: pinnedItems.map((pinnedItem, index) => {
                      ...
                      return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(
                        Link,
                        {
                          ...
                          children: [
                            pinnedItem.label,
                            selected && /* @__PURE__ */ jsx(SelectedIcon, {})
                          ]
                        }
...
const HTMLLinkBase = ({
  ...
  if (disabled) {
    ...
    return /* @__PURE__ */ jsx("a", { role, "aria-disabled": "true", className, ...withRef, children });
  }
  if (isExternal) {
  ...
  if (isAnchor) {
    return /* @__PURE__ */ jsx("a", { href: link, className, ...rest, ...withRef, children });
  }
  if (RouterLink) {
    return /* @__PURE__ */ jsx(
      RouterLink,
...
function Placeholder({ placeholderName, teamId, name }) {
  ...
  return /* @__PURE__ */ jsx(
    "span",
    {
      ...
      children: placeholderName ? lodashSplit(placeholderName, "", 1)[0].toUpperCase() : /* @__PURE__ */ jsx(
        "svg",
        {
          viewBox: "0 0 100 100",
...
const Navigation = ({
  ...
  return /* @__PURE__ */ jsx(List, { className: listCN, ...rest, children: validChildren.map((child, index) => {
    if (!child) {
      return null;
    }
    return /* @__PURE__ */ jsxs("li", { className: itemCN, children: [
      child,
      separator && index !== childrenCount && /* @__PURE__ */ jsx(
        DecorativeIcon,
        {
          name: "nav-separator",
...
const notificationsButtonCN = ({ isOpen }) => cn(
...
const listItemCN = ({ watermark, primary }) => cn(
  "tw-border-b",
...
const listItemLinkCN = ({ isHighlighted, watermark, primary }) => cn(
  "tw-flex",
  "tw-items-stretch",
  "tw-px-4",
  "tw-py-6",
...
const listItemHeadingCN = ({ watermark }) => cn(
  "dark:tw-text-gray-lightest",
  "tw-font-semibold",
  "tw-leading-normal",
  "tw-m-0",
...
const externalLinkCN = ({ isHighlighted }) => cn(
  "tw-bg-none",
  "tw-border-none",
  "tw-text-teal-darkest",
  "tw-inline-block",
...
function SupportDropdown({
  ...
  return /* @__PURE__ */ jsx(Downshift, { onSelect: handleSelect, isOpen, children: ({
    getToggleButtonProps,
    getLabelProps,
    getItemProps,
    isOpen: isOpen2,
    ...
    if (showUpgrade) {
      items.push({
        ...
        children: /* @__PURE__ */ jsx(Button, { variant: "pop", children: "Upgrade" })
      });
    } else {
      items.push(
        {
          ...
          description: /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx("strong", { className: "tw-font-semibold", children: "Visit your dedicated Slack channel" }),
            " ",
        ...
        },
        {
          ...
          description: /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            " ",
            /* @__PURE__ */ jsx("strong", { className: "tw-font-semibold", children: "call us at your team’s dedicated phone number" }),
            "."
          ] })
        }
      );
    }
    return /* @__PURE__ */ jsxs("div", { className: dropdownWrapperCN, children: [
      /* @__PURE__ */ jsxs(
        Button,
        {
          ...getToggleButtonProps({
          ...
          children: [
            /* @__PURE__ */ jsx(
              DecorativeIcon,
              {
                className: cn("tw-shrink-0", "tw-mr-3", isOpen2 && "tw-hidden"),
                focusable: "false",
                name: "nav-support"
              }
            ),
      ...
      isOpen2 && /* @__PURE__ */ jsx(
        "aside",
        {
          className: cn(asideCN, {
            "tw-left-auto tw-right-0": align === "right"
          }),
          children: /* @__PURE__ */ jsx("ul", { className: "tw-h-full tw-max-h-notifications-list tw-overflow-auto lg-height:tw-max-h-170", children: items.map(
            ({
              title,
              iconName,
              href,
                ...
                "li",
                {
                  ...
                  children: /* @__PURE__ */ jsxs(
                    Component,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxs("span", { className: "tw-sr-only", children: [
                          "Support: ",
                          title
                        ] }),
                        iconName && /* @__PURE__ */ jsx(
                        ...
                        /* @__PURE__ */ jsxs("div", { children: [
                          /* @__PURE__ */ jsx("div", { className: "tw-flex tw-items-start tw-justify-between", children: /* @__PURE__ */ jsxs(
                            "p",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsx("span", { className: "tw-not-sr-only", children: title }),
                                badge && /* @__PURE__ */ jsx("span", { className: badgeCN, children: badge })
                              ]
                            }
                          ) }),
                          /* @__PURE__ */ jsx("p", { className: metaCN({ watermark }), children: description }),
                          children && /* @__PURE__ */ jsx(
                            "p",
                            {
                              className: cn(
  ...
  const dropdownOptions = [
    {
      label: /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("strong", { "data-user-name": name, className: "h4 tw-block", children: name }),
        /* @__PURE__ */ jsx("small", { "data-user-email": email, className: "meta", children: email })
      ] }),
      to: userPath
    },
    ...links,
  ...
  return /* @__PURE__ */ jsx(
    Dropdown,
    {
      ...
      toggle: {
        ...
        className: "tw-relative tw-rounded-full tw-w-9 tw-h-9 hover:tw-ring-2 focus:tw-ring-2",
        label: /* @__PURE__ */ jsx(
          Avatar,
          {
            user,
...
export {
  ...
  capitalize,
  cn,
  createExternalTeamsOrganization,
  generateImageUrl,
  getActualSizeForNumberValue,
  getNormalizedPlanNameFromAccount,
  getPlaceholderGradientColorsFromId,
  getPlanTitleFromAccount,
  hideOnEsc,
  hideOnPopperBlur,
  humanizePlanName,
  isAvatarUrlCustomUpload,
  isExternalTeamsOrganization,
  isNetlifyUrl,
