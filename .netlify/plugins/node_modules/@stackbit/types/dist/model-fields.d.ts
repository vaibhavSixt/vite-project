...
export type DistributeFieldsExtension<Type extends Field> = Type extends {
    type: 'object';
...
export type DistributePartialListItems<Type extends FieldListItems> = Type extends {
    type: 'object';
...
export type FieldInitialValueFunction = (options: {
    data: Record<string, any>;
    locale?: string;
} & ConfigDelegate) => Promise<unknown>;
export type FieldBasicProps = FieldStringProps | FieldUrlProps | FieldSlugProps | FieldTextProps | FieldMarkdownProps | FieldHtmlProps | FieldBooleanProps | FieldDateProps | FieldDatetimeProps | FieldColorProps | FieldJsonProps | FieldRichTextProps | FieldFileProps;
...
export type DistributeFieldListItemsEnumProps<Type extends FieldEnumProps> = Type extends FieldEnumProps ? {
    type: 'list';
    items: Type;
} & FieldCustomControlTypeProps<'checkbox'> : never;
...
export type DocumentPreviewFunction = (options: {
...
export type ObjectPreviewFunction = (options: {
