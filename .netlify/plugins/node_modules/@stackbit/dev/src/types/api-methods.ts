...
export type APIMethodCreateAndLinkDocument = {
    ...
    result: { srcDocumentId: string; createdDocumentId: string };
};
...
export type APIMethodCreateScheduledAction = {
    ...
    result: { newScheduledActionId: string };
};
...
export type APIMethodCancelScheduledAction = {
    ...
    result: { cancelledScheduledActionId: string };
};
...
export type APIMethodUpdateScheduledAction = {
    ...
    result: { updatedScheduledActionId: string };
};
...
export type APIMethodGetStagedChanges = {
    ...
    legacyData?: void;
    result: { changes: ContentStoreTypes.StagedChange[] };
    legacyResult: void;
};
