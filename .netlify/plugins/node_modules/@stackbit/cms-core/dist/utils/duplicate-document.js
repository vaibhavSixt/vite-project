...
exports.mergeObjectWithDocument = void 0;
const lodash_1 = __importDefault(require("lodash"));
const content_store_utils_1 = require("../content-store-utils");
const common_schema_1 = require("../common/common-schema");
function mergeObjectWithDocument({ object, document, locale, contentSourceId, contentSourceDataById, seenReferences = [], referenceBehavior, duplicatableModels, nonDuplicatableModels }) {
...
exports.mergeObjectWithDocument = mergeObjectWithDocument;
function mergeObjectWithDocumentFields({ object, documentFields, ...context }) {
    return lodash_1.default.reduce(documentFields, (object, documentField, fieldName) => {
...
function mergeObjectWithDocumentField({ value, documentField, ...context }) {
    ...
    switch (documentField.type) {
        ...
        case 'richText': {
            ...
            const localizedField = (0, content_store_utils_1.getDocumentFieldForLocale)(documentField, locale);
            if (localizedField) {
        ...
        case 'image': {
            ...
            if (localizedField && !localizedField.isUnset) {
                ...
                const localizedUrl = (0, content_store_utils_1.getDocumentFieldForLocale)(localizedField.fields.url, locale);
        ...
        case 'cross-reference': {
            ...
            if (localizedField && !localizedField.isUnset && isPlainObjectOrUndefined(value)) {
                ...
                if (localizedField.refType === 'asset') {
                    ...
                    const contentSourceId = (0, content_store_utils_1.getContentSourceId)(localizedField.refSrcType, localizedField.refProjectId);
        ...
        case 'list': {
            ...
            if (localizedField) {
                return (localizedField.items ?? [])
                    .map((field) => mergeObjectWithDocumentField({
                    value: undefined,
                    documentField: field,
                    ...context
                }))
...
function isPlainObjectOrUndefined(value) {
    return typeof value === 'undefined' || lodash_1.default.isPlainObject(value);
}
function shouldDuplicate({ referenceField, modelName, seenReferences, referenceBehavior, nonDuplicatableModels, duplicatableModels }) {
    return (!seenReferences.includes(referenceField.refId) &&
        modelName !== common_schema_1.IMAGE_MODEL.name &&
