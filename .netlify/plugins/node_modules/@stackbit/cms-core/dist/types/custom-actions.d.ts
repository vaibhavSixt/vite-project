import { CustomActionGlobal, CustomActionBulk, CustomActionDocument, CustomActionObjectModel, CustomActionObjectField, CustomActionField, CustomActionState, CustomActionInputField, CustomActionPermissions } from '@stackbit/types';
...
export type ExtendedCustomAction = ExtendedCustomActionGlobal | ExtendedCustomActionBulk | ExtendedCustomActionDocument | ExtendedCustomActionObjectModel | ExtendedCustomActionObjectField | ExtendedCustomActionField;
...
export type ExtendedCustomActionObjectModel = Omit<CustomActionObjectModel, 'type'> & ContentStoreCustomActionCommonProps & {
    type: 'objectModel';
    documentSpec: APICustomActionDocumentSpecifier;
    fieldPath: (string | number)[];
};
export type ExtendedCustomActionObjectField = Omit<CustomActionObjectField, 'type'> & ContentStoreCustomActionCommonProps & {
    type: 'objectField';
    documentSpec: APICustomActionDocumentSpecifier;
    fieldPath: (string | number)[];
};
...
export type APIRunCustomActionRequest = APIRunCustomActionRequestGlobal | APIRunCustomActionRequestBulk | APIRunCustomActionRequestDocument | APIRunCustomActionRequestObject | APIRunCustomActionRequestField;
