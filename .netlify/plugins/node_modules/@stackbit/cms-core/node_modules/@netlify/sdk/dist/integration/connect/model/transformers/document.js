    ...
    parseVisitedInputSingle(visited, field, treeContext) {
        if (field.isRootValue) {
            ...
            if (!visited._createdAt &&
                this.definition.ModelBuilder.shouldHandleCreateSupport()) {
                throw new ModelError(`Inserted document is missing a "${this.definition.getTypeName()}._createdAt" field value. Connectors that support Netlify visual editor must include a _createdAt value on every inserted document.`);
            }
