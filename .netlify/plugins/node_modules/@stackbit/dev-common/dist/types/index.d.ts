...
import { DocumentFilePathFunction, UserCommandSpawner, Document, SidebarButton, DistributiveOmit, AssetSource, Viewport, DocumentPermissions } from '@stackbit/types';
...
export interface MappedModels {
    [projectId: string]: {
        [modelName: string]: Model | ImageModel;
    };
}
...
export interface CMSInterface {
    ...
    postPull(updatedFiles: string[], options?: {
        spawnRunner?: UserCommandSpawner;
    }): Promise<{
...
export type Schema = {
    ...
    actions: Array<ContentStoreTypes.APICustomAction & {
        type: 'global' | 'bulk';
    }>;
    settings: {
        hcrHandled?: boolean;
