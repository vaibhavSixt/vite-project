...
module.exports = class Git {
    ...
    async postPull(updatedFiles) {
        ...
        const { updatedCodeFiles = [], updatedContentFiles = [], updatedSchemaFiles = [] } = _.groupBy(updatedFiles, (filePath) => {
    ...
    async updateObject(changedFields, user) {
        ...
        return Promise.all(Object.keys(fieldsByEntity).map(async (srcObjectId) => {
