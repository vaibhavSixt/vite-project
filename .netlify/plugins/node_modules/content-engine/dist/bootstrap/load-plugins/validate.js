...
var _package = require("content-engine/package.json");
...
function warnOnIncompatiblePeerDependency(name, packageJSON) {
  ...
  const gatsbyPeerDependency = (0, _get2.default)(packageJSON, `peerDependencies.content-engine`);
  if (gatsbyPeerDependency && !semver.satisfies(_package.version, gatsbyPeerDependency, {
    includePrerelease: true
  })) {
    _reporter.default.warn(`Plugin ${name} is not compatible with your gatsby version ${_package.version} - It requires content-engine@${gatsbyPeerDependency}`);
  }
}
