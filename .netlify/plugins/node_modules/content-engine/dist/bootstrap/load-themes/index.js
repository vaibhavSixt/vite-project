...
async function loadThemes(config, {
  ...
  var _config$plugins;
  const themesA = await (0, _bluebird.mapSeries)(((_config$plugins = config.plugins) === null || _config$plugins === void 0 ? void 0 : _config$plugins.filter(plugin =>
  // @ts-ignore
  (plugin === null || plugin === void 0 ? void 0 : plugin.resolve) !== `default-site-plugin` && plugin !== `default-site-plugin`)) || [], async themeSpec => {
